  ...
  return (
    <Box className='w-full h-screen bg-white dark:bg-zinc-900'>
      <Box className='border-l border-r border-dashed dark:border-zinc-700/50 px-10 md:pt-5 mx-10 mt-16 lg:mt-28 pb-5 ml-auto mr-auto flex justify-center items-center max-w-xs' >
        <Link to='*' className='flex justify-center items-center gap-x-2 bg-zinc-50 dark:bg-zinc-800/50 px-3.5 py-1.5 rounded-full mx-auto border border-zinc-100 dark:border-zinc-700/50 hover:opacity-50' >
      ...
      <Box>
        <Text className='mx-7 lg:mx-14 py-10 text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold xl:font-black border-t border-b border-dashed dark:border-zinc-700/50 text-center dark:text-zinc-300 xl:leading-[120px]' >The Landing for every tech</Text>
      ...
      <Flex gap={"4"} className='text-sm md:text-base sm:border-l sm:border-r border-dashed dark:border-zinc-700/50 px-10 pt-10 pb-5 mx-10 ml-auto mr-auto flex justify-center items-center max-w-md' >
          ...
          <Link to='docs' className='px-10 py-2.5 rounded-lg bg-black text-white font-semibold hover:opacity-50 dark:bg-zinc-800' >Explore</Link>
      </Flex>
    </Box>
  )
}
